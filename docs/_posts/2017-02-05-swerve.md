...
<img width="1050" height="1297" src="{{ '/images/swerve/SfTtbC9.jpg' | absolute_url }}" />
...
<img width="1400" height="1050" src="{{ '/images/swerve/vvT8YDw.jpg' | absolute_url }}" />

Used keyboard-layout-editor.com and builder.swillkb.com to design plates and I had lasergist.com cut it.

<img width="1315" height="1400" src="{{ '/images/swerve/2M9tA0U.jpg' | absolute_url }}" />

Sandblasted finish is gorgeous!     Looks Apple quality

<img width="1400" height="923" src="{{ '/images/swerve/Av2hsOS.jpg' | absolute_url }}" />

Reused Cherry MX  Browns from an unused CM Storm

<img width="1400" height="762" src="{{ '/images/swerve/NIyPrvW.jpg' | absolute_url }}" />

I hate hand-wiring, but this came out okay, took a few hours.

<img width="1400" height="1063" src="{{ '/images/swerve/LvgGLhh.jpg' | absolute_url }}" />

This Teensy 2.0 wiring is hideous but really wanted to try it out.

<img width="1393" height="649" src="{{ '/images/swerve/tYTfr0v.jpg' | absolute_url }}" />
...
<img width="1400" height="1384" src="{{ '/images/swerve/8isthNz.jpg' | absolute_url }}" />
