...
<img width="3509" height="1537" src="{{ '/images/c64p2/SngtO97.jpg' | absolute_url }}" />
This is part 2 of my retrofuture ortholinear Commodore 64 keyboard.

<img width="1735" height="1400" src="{{ '/images/c64p2/IxdmVhd.jpg' | absolute_url }}" />
...
<img width="2027" height="1300" src="{{ '/images/c64p2/9Teay0J.jpg' | absolute_url }}" />
...
<img width="1400" height="1400" src="{{ '/images/c64p2/xdR6IRB.jpg' | absolute_url }}" />
I need a center mount 2u for the Return/Enter key so I cut one support out with Dremel.

<img width="1400" height="1400" src="{{ '/images/c64p2/oSyFITI.jpg' | absolute_url }}" />
I drilled new MX holes in the PCB

<img width="1400" height="1242" src="{{ '/images/c64p2/hFF8DTD.jpg' | absolute_url }}" />
I shrinkwrapped the switch leads to avoid contacting the ground or any leads.

<img width="1400" height="1693" src="{{ '/images/c64p2/dYYraPd.jpg' | absolute_url }}" />
It looks and works great!

<img width="2344" height="1200" src="{{ '/images/c64p2/7DiJCc2.jpg' | absolute_url }}" />
I used Gateron reds to be closer to the C64's linear switches

<img width="2079" height="1400" src="{{ '/images/c64p2/kYBxLU1.jpg' | absolute_url }}" />
...
<img width="1174" height="1548" src="{{ '/images/c64p2/lOBHh0q.jpg' | absolute_url }}" />
...
<img width="2564" height="1400" src="{{ '/images/c64p2/5A8DsiS.jpg' | absolute_url }}" />
I glued and clamped wood to fit the PCB.

<img width="2129" height="1400" src="{{ '/images/c64p2/0Yv378o.jpg' | absolute_url }}" />
Sanded the case and drilled a hole for the USB.

<img width="2062" height="1400" src="{{ '/images/c64p2/nuYs7Wc.jpg' | absolute_url }}" />
Stained with a Mahogany stain.

<img width="2410" height="1400" src="{{ '/images/c64p2/EcpIF0F.jpg' | absolute_url }}" />
Then I coated and buffed with paste wax.

<img width="2393" height="1200" src="{{ '/images/c64p2/tk8NDg8.jpg' | absolute_url }}" />
I hand cut and drilled a Plexiglass bottom.

<img width="1400" height="1358" src="{{ '/images/c64p2/Y9TsnWz.jpg' | absolute_url }}" />
Since the XD75 has RGB backlight, I wanted better diffusion so I soda blasted the bottom.

<img width="2449" height="1400" src="{{ '/images/c64p2/2WE7tGe.jpg' | absolute_url }}" />
Looks good!

<img width="1400" height="1672" src="{{ '/images/c64p2/SRZREdd.jpg' | absolute_url }}" />
Had a friendly neighborhood metal shop cut down a thin stainless plate to back the plexglass.

<img width="2808" height="1400" src="{{ '/images/c64p2/vqCyfoi.jpg' | absolute_url }}" />
