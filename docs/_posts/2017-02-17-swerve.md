...
<img width="1600" height="1200" src="{{ '/images/swerve2/bIWx3iW.jpg' | absolute_url }}" />
Finished the under-lit case for my DIY hand-wired keyboard, handmade it using Rosewood, Plexiglass, and Aluminum bottom.

<img width="1600" height="838" src="{{ '/images/swerve2/uiEnLYN.jpg' | absolute_url }}" />
...
<img width="1200" height="800" src="{{ '/images/swerve2/PABABvC.jpg' | absolute_url }}" />
...
<img width="1200" height="1136" src="{{ '/images/swerve2/SZCFBtH.jpg' | absolute_url }}" />
Extended the Teensy controller by splitting apart a micro USB to mini USB adapter...

<img width="1200" height="976" src="{{ '/images/swerve2/j4qxUyx.jpg' | absolute_url }}" />
... then cut a hole and epoxied the adapter to keep the cable mount clean, and also to...

<img width="1200" height="938" src="{{ '/images/swerve2/5p9FeZQ.jpg' | absolute_url }}" />
...give me better, cheaper cable options like this.

<img width="1200" height="696" src="{{ '/images/swerve2/kIlnSy0.jpg' | absolute_url }}" />
Looks great, aside from a few incorrect key cap legends (see below)

<img width="1034" height="1200" src="{{ '/images/swerve2/ufsUNFH.jpg' | absolute_url }}" />
The frame was made from Bolivian Rosewood, and I hand cut the miters.

<img width="1200" height="900" src="{{ '/images/swerve2/fhUVvm4.jpg' | absolute_url }}" />
after glueing frame, added some warm white 5V strip LED around the inside.  Testing the Stargate with a battery here.

<img width="1200" height="1342" src="{{ '/images/swerve2/PMQ6BPw.jpg' | absolute_url }}" />
Wired up to the Nyan Cat... Teensy 2.0 controler Backlight pins

<img width="1500" height="888" src="{{ '/images/swerve2/n0VtNEh.jpg' | absolute_url }}" />
Bit of a disaster with the hot glue gun, but it all works.

<img width="1200" height="860" src="{{ '/images/swerve2/DLFJ2rZ.jpg' | absolute_url }}" />
The LED under glow is warmer than the picture shows.  It has a very retro 70s/early 80s electronics look.

<img width="1500" height="791" src="{{ '/images/swerve2/4ZVqZkh.jpg' | absolute_url }}" />
