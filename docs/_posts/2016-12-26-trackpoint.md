...
<img width="1600" height="1200" src="{{ '/images/trackpoint/Kj4spcz.jpg' | absolute_url }}" />
Bought a used Lenovo USB Trackpoint keyboard...

<img width="1600" height="1200" src="{{ '/images/trackpoint/O3R2ZLM.jpg' | absolute_url }}" />
and pulled the Trackpoint module out of it

<img width="1600" height="632" src="{{ '/images/trackpoint/Hdg2E8m.jpg' | absolute_url }}" />
I used shifted ISO Colemak layout on the bottom row, so I have an unused key between B & K

<img width="1600" height="2133" src="{{ '/images/trackpoint/A6eQ4uS.jpg' | absolute_url }}" />
Opened a broken Cherry MX switch, then cut and sanded flat.

<img width="1200" height="1021" src="{{ '/images/trackpoint/SOVfmUo.jpg' | absolute_url }}" />
Epoxied it to a piece of craft metal I cut to size

<img width="1200" height="1600" src="{{ '/images/trackpoint/QUd8Bf1.jpg' | absolute_url }}" />
I used thin, permanent mounting tape to attach the Trackpoint sensor to the other side

<img width="1184" height="1600" src="{{ '/images/trackpoint/UMBquWw.jpg' | absolute_url }}" />
I found a  nylon bushing at the hardware store that fit the Trackpoint nub tightly, then epoxied them together

<img width="1200" height="1600" src="{{ '/images/trackpoint/HsHFrbN.jpg' | absolute_url }}" />
...
<img width="1200" height="1600" src="{{ '/images/trackpoint/HmrS7m1.jpg' | absolute_url }}" />
Widened the MX mounting hole to pass the sensor tape through the PCB

<img width="1200" height="1600" src="{{ '/images/trackpoint/CxcYG69.jpg' | absolute_url }}" />
Ready for the FrankenTrackpoint

<img width="1473" height="1600" src="{{ '/images/trackpoint/VdnNdE8.jpg' | absolute_url }}" />
After some trimming, fits perfectly

<img width="1200" height="1600" src="{{ '/images/trackpoint/BQqI2ta.jpg' | absolute_url }}" />
...
<img width="1600" height="1200" src="{{ '/images/trackpoint/ohrR1zn.jpg' | absolute_url }}" />
...
<img width="1600" height="1354" src="{{ '/images/trackpoint/ASukKcC.jpg' | absolute_url }}" />
