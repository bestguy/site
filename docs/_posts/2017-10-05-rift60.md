...
<img width="1963" height="1440" src="{{ '/images/rift60/GeUlboL.jpg' | absolute_url }}" />

All the things: Ortho, split, Colemak, GH60, DSA, Hand-wired, Laser-cut, TKL compatible keycaps.

<img width="1621" height="2000" src="{{ '/images/rift60/8ULKnTP.jpg' | absolute_url }}" />

Walnut veneer MDF plate laser cut from Ponoko for ~$50

<img width="1918" height="1376" src="{{ '/images/rift60/3iWtTSH.jpg' | absolute_url }}" />

Stained and waxed the plate,  which is designed to fit standard GH60 60% keyboard cases.

<img width="2016" height="1387" src="{{ '/images/rift60/A0Vffa3.jpg' | absolute_url }}" />

Hot glued Gateron Browns.  The ugly cutout is to make room for Teensy 2.0 controller

<img width="2000" height="1459" src="{{ '/images/rift60/ToUWXmp.jpg' | absolute_url }}" />

Hand-wiring is ugly, but it works

<img width="1963" height="1231" src="{{ '/images/rift60/m9wrPFr.jpg' | absolute_url }}" />
...
<img width="2000" height="1402" src="{{ '/images/rift60/jEd0PYw.jpg' | absolute_url }}" />

Aluminum case is from NPKC on Amazon.  Keycaps are Think Different from PMK.

<img width="2000" height="1322" src="{{ '/images/rift60/9WosN2G.jpg' | absolute_url }}" />
...
<img width="1960" height="1394" src="{{ '/images/rift60/sW1ENai.jpg' | absolute_url }}" />
